...
int32_t swi_m2s_init(swi_m2s_info_t* m2s_info, read_op hw_read, rx_op hw_rx, void* rd_hndl,
                     unsigned int idx)
{
    int32_t ret = 0;
    ...
    EventBits_t uxBits = xEventGroupClearBits(m2s_info->evt_grp,
                                              SWI_M2S_BLOCKED_READER | SWI_M2S_UNBLOCK_READER);
